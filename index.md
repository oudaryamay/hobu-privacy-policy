...
Hobu mobile application ("the App"). This version is designed to comply
with Google Play and Apple App Store privacy disclosure requirements.
...
We collect the following categories of data to operate and improve the
App.
